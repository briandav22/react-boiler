...
const expenseTwo = store.dispatch(addExpense({description:'cofee', amount:400, createdAt:1000}))
...
// store.dispatch(setStartDate(12005))

store.dispatch(setEndDate(12005))
const demoState = {
    expenses : [{
        id: 'someid',
        description: 'rent',
        note: 'this was final rent payment',
        amount: 54500,
        createdAt: 0
